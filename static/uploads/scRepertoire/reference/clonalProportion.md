...
`clonalSplit`, at default, `clonalSplit` will group the clones into bins
of 1:10, 11:100, 101:1001, etc. To adjust the clones selected, change
the numbers in the variable split. If a matrix output for the data is
...
- clonal.split:
  ...
  The cut points for the specific clones, default = c(10, 100, 1000,
  10000, 30000, 1e+05)
...
- clonalSplit:
  ...
  **\[deprecated\]** Use `clonal.split` instead.
