...
awd <- cv$awards %||% list()
if (length(awd)) {
  cat(map_chr(awd, ~ glue("- {._$year}: **{._$name}**")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(sft)) {
  cat(map_chr(sft, ~ glue("- **[{._$name}]({._$link})** ({._$year}) — {._$role}. {._$description}")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(inst)) {
  cat(map_chr(inst, ~ glue("- {._$years}: *{._$title}* — {._$sponsor}. Role: **{._$role}**")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(nat)) {
  cat(map_chr(nat, ~ glue("- {._$years}: *{._$title}* — {._$sponsor}. Role: **{._$role}**")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(ipi)) {
  cat(map_chr(ipi, ~ glue("- {._$year}: *{._$title}*. {._$venue}")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(ipn)) {
  cat(map_chr(ipn, ~ glue("- {._$year}: *{._$title}*. {._$venue}")), sep = "\n")
} else cat("_(none listed)_")
```
...
if (length(abs)) {
  cat(map_chr(abs, ~ glue("- {._$year}: {embolden_me(._$authors)}. *{._$title}*. {._$venue}")), sep = "\n")
} else cat("_(none listed)_")
```
