...
software:
  - name: "scRepertoire"
    ...
    desc: "Single-cell immune receptor profiling: combine TCR/BCR data with scRNA-seq for clonal quantification, diversity, and overlap."
    role: "Author"
  ...
  - name: "Ibex"
    ...
    desc: "The BCR counterpart to Trex: vectorizes immunoglobulin CDR3 sequences for repertoire-based clustering."
    role: "Author"
    pub: "https://doi.org/10.1101/2022.11.09.515787"
  - name: "immApex"
    url: "https://github.com/BorchLab/immApex"
    desc: "A unified interface for machine learning on adaptive immune receptor sequences, from featurization to benchmarking."
    role: "Author"
